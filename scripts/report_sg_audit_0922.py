...
def main() -> None:
    ...
    print("═══ [SG] 有 issues 的 ads（拒审/投放错误）═══")
    n_iss = 0
    for a in ads:
    ...
    acts = g._get_all(
        f"{s.meta.account_path}/activities",
